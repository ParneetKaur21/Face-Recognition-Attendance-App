...
class Face_Recognition:
    def __init__(self, root):
        ...
        f_lbl.place(x=0, y=55, width=550, height=600)
        ...
        img_right = img_right.resize((800, 600), Image.LANCZOS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl = Label(self.root, image=self.photoimg_right)
        f_lbl.place(x=550, y=55, width=800, height=600)

        # Button
        b1_1 = Button(f_lbl, text="Face Recognition", cursor="hand2", font=("times new roman", 16, "bold"), bg="dark green", fg="white", command=self.face_recog)
        b1_1.place(x=320, y=530, width=170, height=40)


        #attendance
    def mark_attendance(self,i,r,n,d):
        with open("Parneet.csv","r+",newline="\n") as f:
        ...
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                try:
                    ...
                    my_cursor.execute("SELECT std_name FROM student WHERE std_id=%s", (str(id),))
